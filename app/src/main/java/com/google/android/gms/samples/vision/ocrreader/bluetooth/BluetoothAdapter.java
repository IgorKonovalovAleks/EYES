...
public final class BluetoothAdapter {
    ...
    android.bluetooth.BluetoothAdapter bluetoothAdapter; //Экземпляр более низкоуровневого библиотечного класса

    ArrayList<String> pairedDeviceArrayList; //Список сопряженных устройств

    private UUID myUUID;

    ThreadConnectBTDevice myThreadConnectBTDevice; //Экземпляр внутреннего класса для подключения к устройствам
    ThreadConnected myThreadConnected; //Экземпляр внутреннего класса для отправки данных
    Context context;
